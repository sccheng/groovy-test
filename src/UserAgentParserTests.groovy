...
class UserAgentParserTests extends GroovyTestCase {
    ...
    void testPythonUserAgent1() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "python", sdk_version: "2.18.1", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }

    void testPythonUserAgent2() {
        String userAgent = "watson-developer-cloud-python-0.26.0"
        def expected = JsonOutput.toJson([sdk_language: "python", sdk_version: "0.26.0", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testPythonUserAgent3() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "Python", sdk_version: "2.7", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testPythonUserAgent4() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "PycURL", sdk_version: "7.43.0", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testJavaUserAgent1() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "java", sdk_version: "3.7.2", os: "(java.vendor=Oracle Corporation; java.version=1.8.0_45; os.arch=amd64; os.name=Linux; os.version=4.1.13-19.30.amzn1.x86_64)", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testJavaUserAgent2() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "", sdk_version: "", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testJavaUserAgent3() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "java", sdk_version: "3.5.10-SNAPSHOT", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testJavaUserAgent4() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "java", sdk_version: "2.0.0", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testJavaUserAgent5() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "Java", sdk_version: "1.8.0_91", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testJavaUserAgent6() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "Java", sdk_version: "1.8.0", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testNodeUserAgent1() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "nodejs", sdk_version: "2.33.0", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testSwiftUserAgent1() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "swift", sdk_version: "0.14.0", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testGoUserAgent1() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "Go", sdk_version: "1.1", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
    ...
    void testGoUserAgent2() {
        ...
        def expected = JsonOutput.toJson([sdk_language: "Golang", sdk_version: "v0.1", os: "", raw: userAgent])
        def parsedResult = UserAgentParser.parse(userAgent)
        assertEquals(expected, parsedResult)
    }
